-- EMERGENCY FIX: Fix delete_assistance_safely function to prevent foreign key constraint violation
-- The issue is that we're trying to log the deletion with assistance_id after deleting the assistance
...
BEGIN
    ...
    -- Começar transação
    BEGIN
        -- Eliminar registos das tabelas dependentes primeiro (ordem importante)
        ...
        -- Registar o evento de eliminação DEPOIS de eliminar (sem assistance_id para evitar constraint violation)
