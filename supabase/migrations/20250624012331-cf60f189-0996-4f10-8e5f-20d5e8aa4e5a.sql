...
-- Corrigir definitivamente a função delete_assistance_safely removendo todas as referências ao storage
...
BEGIN
    ...
    BEGIN
        ...
        -- Eliminar registos das tabelas dependentes (SEM tentar eliminar do storage)
