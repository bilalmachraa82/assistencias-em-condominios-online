    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-white p-0 border-gray-300 text-gray-700 hover:bg-gray-50 hover:text-gray-900"
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 text-gray-900 hover:bg-blue-50 hover:text-blue-900"
        ),
