  ...
  return <div className="rounded-md border">
      <Table>
        <TableHeader className="bg-white hover:bg-white">
          <TableRow>
            <TableHead className="bg-slate-50">Nome</TableHead>
        ...
        <TableBody>
          {isLoading ? <TableRow>
              ...
              <TableCell colSpan={6} className="text-center">
                ...
                <TableCell>{building.admin_notes || '-'}</TableCell>
                <TableCell>
                ...
                <TableCell>
                  <div className="flex space-x-2">
                    ...
                    <Button variant="outline" size="sm" onClick={() => onEdit(building)} className="flex items-center gap-1 text-emerald-700">
                      <Edit className="h-3 w-3" />
                      Editar
                    </Button>
                    
                    <Button variant="outline" size="sm" onClick={() => onDelete(building)} className="flex items-center gap-1 text-red-600 hover:text-red-800 hover:bg-red-50">
